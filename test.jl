...
function my_custom_train!(loss, data, opt, model, BATCHSIZE)
    for EPOCH in 1:5
        ...
        cpu_model = cpu(model)
        @save "mymodel_$EPOCH.bson" cpu_model
    end
end
...
hyper = Dict{String, Any}("cls_pw"=>1, "obj_pw"=>1, "anchor_t"=>4.0, "box"=>0.05f0, "cls"=>0.3f0, "obj"=>0.7f0)
...
# tcls, tbox, indices, anch = YOLOv7.build_targets(cl, ŷ, y)
# YOLOv7.build_targets(cl, ŷ, y)
l = YOLOv7.loss(cl, ŷ, y, 1)
